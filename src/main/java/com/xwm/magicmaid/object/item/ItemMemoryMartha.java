...
public class ItemMemoryMartha extends ItemBase
{
    public ItemMemoryMartha(String name) {
        super(name);
        setMaxStackSize(1);
    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        if (handIn == EnumHand.MAIN_HAND){
            playerIn.openGui(Main.instance, Reference.GUI_MAID_MEMORY, worldIn, 0, 0,0 );
