...
public class ModelMagicMaidRettDemonKillerStand extends ModelMagicMaidRettBone {
    ...
    public ModelMagicMaidRettDemonKillerStand() {
        ...
        this.setRotateAngle(leftSleeve, -0.7285004297824331F, 0.40980330836826856F, -0.36425021489121656F);
        ...
        this.setRotateAngle(rightSleeve, -0.9560913642424937F, -0.8196066167365371F, 0.0F);
        ...
        this.handle.setRotationPoint(0.0F, 10.5F, 0.0F);
        this.handle.addBox(-0.5F, -1.0F, -0.5F, 1, 6, 1, 0.0F);
        this.setRotateAngle(handle, 0.0F, -1.2747884856566583F, -0.6373942428283291F);
