 ...
 */
public class ModelMagicMaidRettDemonKillerAttack3 extends ModelMagicMaidRettBone {

    public ModelMagicMaidRettDemonKillerAttack3() {
        super();
        ...
        this.handle.setRotationPoint(1.0F, 10.0F, 1.0F);
        this.handle.addBox(-0.5F, -1.0F, -0.5F, 1, 6, 1, 0.0F);
        this.setRotateAngle(handle, -1.9547687622336491F, -0.47123889803846897F, 2.0943951023931953F);
        ...
        this.setRotateAngle(rightSleeve, -2.356194490192345F, -0.5235987755982988F, 0.0F);
        ...
        this.setRotateAngle(leftSleeve, -2.356194490192345F, 0.5235987755982988F, 0.0F);
