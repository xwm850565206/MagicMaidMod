...
//        topBlock = Blocks.STONE.getDefaultState();
        ...
        this.spawnableCreatureList.add(new Biome.SpawnListEntry(EntityVillager.class, 1, 4, 4));
        this.spawnableCreatureList.add(new Biome.SpawnListEntry(EntityPigZombie.class, 1, 1, 1));
