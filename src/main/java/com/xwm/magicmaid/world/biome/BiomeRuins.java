...
//        topBlock = Blocks.STONE.getDefaultState();
        ...
        this.spawnableCreatureList.add(new Biome.SpawnListEntry(EntityBat.class, 10, 1, 1));
        this.spawnableMonsterList.add(new Biome.SpawnListEntry(EntityZombie.class, 1, 4, 4));
        this.spawnableMonsterList.add(new Biome.SpawnListEntry(EntityNun.class, 1, 1, 1));
