...
public class EntityInit
{
    ...
    public static void registerEntities(RegistryEvent.Register<EntityEntry> event)
    {
        ...
        registerEntityWithoutEgg(event, Reference.MODID + "_effect_demon_killer", EffectDemonKiller.class, Reference.ENTITY_EFFECT_DEMONKIllER, 50);

        registerEntity(event, Reference.MODID + "_nun", EntityNun.class, Reference.ENTITY_NUN, 50, 0x000000, 0xffffff);
